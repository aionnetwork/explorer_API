...
@Component
public class TransactionImpMysql implements TransactionService {
	...
	@Override
	public List<Object> findAvgsAndCountForToAddressByTimestampRange(long start, long end, int yearStart, int monthStart, int yearEnd, int monthEnd) {
		return txnRepo.findAvgsAndCountForToAddressByTimestampRange(start,end,yearStart,monthStart,yearEnd,monthEnd);
	}

	@Override
	public List<Object> findAvgsAndCountForFromAddressByTimestampRange(long start, long end, int yearStart, int monthStart, int yearEnd, int monthEnd) {
		return txnRepo.findAvgsAndCountForFromAddressByTimestampRange(start,end,yearStart,monthStart,yearEnd,monthEnd);
	}

	@Override
	public Page<Transaction> findTransactionsByAddress(String address, Pageable pageable) {
		return txnRepo.findTransactionsByAddress(address,pageable);
	}

	@Override
	public Page<Transaction> findByDayAndMonthAndYear(int day, int month, int year, Pageable pageable) {
		return txnRepo.findByDayAndMonthAndYear(day,month,year,pageable);
	}

	@Override
	public Transaction findByTransactionHash(String transactionHash) {
		return txnRepo.findByTransactionHash(transactionHash);
	}
}